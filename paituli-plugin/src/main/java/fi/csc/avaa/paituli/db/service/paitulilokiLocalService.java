...
/**
 * Provides the local service interface for paituliloki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see paitulilokiLocalServiceUtil
...
public interface paitulilokiLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link paitulilokiLocalServiceUtil} to access the paituliloki local service. Add custom service methods to {@link fi.csc.avaa.paituli.db.service.impl.paitulilokiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
